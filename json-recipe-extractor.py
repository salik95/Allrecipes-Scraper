...
categ_name = 'appetizers-and-snacks'
data[categ_name] = []
...
# with open('JSON/bread.json') as jsonfile:
# 	for item in json.load(jsonfile)["bread"]:
# 		print(item)

# with open('JSON/cakes.json') as jsonfile:
# 	for item in json.load(jsonfile)["cakes"]:
# 		print(item)

# with open('JSON/candy-and-fudge.json') as jsonfile:
# 	for item in json.load(jsonfile)["candy-and-fudge"]:
# 		print(item)

# with open('JSON/casseroles.json') as jsonfile:
# 	for item in json.load(jsonfile)["casseroles"]:
# 		print(item)

# with open('JSON/christmas-cookies.json') as jsonfile:
# 	for item in json.load(jsonfile)["christmas-cookies"]:
# 		print(item)

# with open('JSON/cocktails.json') as jsonfile:
# 	for item in json.load(jsonfile)["cocktails"]:
# 		print(item)

# with open('JSON/macaroni-and-cheese.json') as jsonfile:
# 	for item in json.load(jsonfile)["macaroni-and-cheese"]:
# 		print(item)

# with open('JSON/main-dish.json') as jsonfile:
# 	for item in json.load(jsonfile)["main-dish"]:
# 		print(item)

# with open('JSON/pasta-and-noodles.json') as jsonfile:
# 	for item in json.load(jsonfile)["pasta-and-noodles"]:
# 		print(item)

# with open('JSON/pasta-salad.json') as jsonfile:
# 	for item in json.load(jsonfile)["pasta-salad"]:
# 		print(item)

# with open('JSON/pies.json') as jsonfile:
# 	for item in json.load(jsonfile)["pies"]:
# 		print(item)

# with open('JSON/pizza.json') as jsonfile:
# 	for item in json.load(jsonfile)["pizza"]:
# 		print(item)

# with open('JSON/sandwiches.json') as jsonfile:
# 	for item in json.load(jsonfile)["sandwiches"]:
# 		print(item)

# with open('JSON/sauces-and-condiments.json') as jsonfile:
# 	for item in json.load(jsonfile)["sauces-and-condiments"]:
# 		print(item)

# with open('JSON/smoothies.json') as jsonfile:
# 	for item in json.load(jsonfile)["smoothies"]:
# 		print(item)

# with open('JSON/soups-stews-and-chili.json') as jsonfile:
# 	for item in json.load(jsonfile)["soups-stews-and-chili"]:
# 		print(item)
